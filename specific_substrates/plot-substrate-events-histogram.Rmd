...
make_graph(iron, sprintf("right_merge_events_iron_%s_%s.png", clock_model, type), "COGs high corr to iron")
make_graph(NO2NO3, sprintf("right_merge_events_nitrogen_%s_%s.png", clock_model, type), "COGs high corr to nitrogen")
make_graph(PO4, sprintf("right_merge_events_phosphate_%s_%s.png", clock_model, type), "COGs high corr to phosphate")
make_graph(oxygen, sprintf("right_merge_events_oxygen_%s_%s.png", clock_model, type),  "COGs high corr to oxygen")
make_graph(inorganic_ion, sprintf("right_merge_events_inorganic_ion_%s_%s.png", clock_model, type),  "inorganic ion COGs")
```
