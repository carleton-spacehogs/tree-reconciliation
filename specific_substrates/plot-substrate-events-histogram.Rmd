...
gen_name = function(k) return(sprintf("events-%snode-%s-plots/%s_%s_%s.png", plot_node, clock_model, plot_node, k, type))
...
g1 = ggplot(loc_dfs, aes_string(x = paste0(plot_node, ".date"), color = "event", y = "substrate", group = "substrate")) + scale_color_manual(values = event_color_scale)

jitter_plot_shared(g1, ytop = length(unique(all_dfs$substrate)))

if (remove_leaf_events) {
  ggsave(sprintf("%s-all-substrate/internal-event-%snode.png", clock_model, plot_node), width = 10, height = 5)
} else {
  ggsave(sprintf("%s-all-substrate/event-%snode.png", clock_model, plot_node), width = 10, height = 5)
}
```
...
gen_loc_name = function(k) return(sprintf("location-%snode-%s-plots/%s_%s_%s.png", plot_node, clock_model, plot_node, k, type))
...
if (remove_leaf_events) {
  ggsave(sprintf("%s-all-substrate/internal-location-%snode.png", clock_model, plot_node), width = 10, height = 5)
} else {
  ggsave(sprintf("%s-all-substrate/location-%snode.png", clock_model, plot_node), width = 10, height = 5)
}
```
...
gen_name2 = function(key_word) return(sprintf("events-posNeg-%snode-%s-plots/location-%s-%s.png", plot_node, clock_model, key_word, type))

if (remove_leaf_events) {
  gen_name2 = function(key_word) return(sprintf("internal-events-posNeg-%snode-%s-plots/internal-location-%s-%s.png", plot_node, clock_model, key_word, type))
}
...
gen_name3 = function(key_word) return(sprintf("location-posNeg-%snode-%s-plots/location-%s-%s.png", plot_node, clock_model, key_word, type))

if (remove_leaf_events) {
  gen_name3 = function(key_word) return(sprintf("internal-location-posNeg-%snode-%s-plots/internal-location-%s-%s.png", plot_node, clock_model, key_word, type))
}
