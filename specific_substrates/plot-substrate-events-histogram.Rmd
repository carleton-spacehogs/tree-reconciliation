...
gen_name2 = function(key_word) return(sprintf("posNeg-%snode-%s-plots/location-%s-%s.png", plot_node, clock_model, key_word, type))

if (remove_leaf_events) {
  gen_name2 = function(key_word) return(sprintf("internal-posNeg-%snode-%s-plots/internal-location-%s-%s.png", plot_node, clock_model, key_word, type))
}
...
gen_name3 = function(key_word) return(sprintf("posNeg-location-%snode-%s-plots/location-%s-%s.png", plot_node, clock_model, key_word, type))

if (remove_leaf_events) {
  gen_name3 = function(key_word) return(sprintf("internal-posNeg-location-%snode-%s-plots/internal-location-%s-%s.png", plot_node, clock_model, key_word, type))
}
