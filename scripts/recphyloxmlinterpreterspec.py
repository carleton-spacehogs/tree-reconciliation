...
for line in eventLines:
	...
	numSpe = int(columns[3]) #gets number of speciations on that branch
	...
	for i in range(numSpe):
		outfile.write('spe' + '\t' + str(leftNode) + '\t' + str(rightNode) + '\t' + str(leftDate) + '\t' + str(rightDate) + '\t' + str(midpointDate) + '\n')
